...
neighborhoods = [
    "20 (Hindustan collage, Nava India Rd, Udayampalayam, Tamil Nadu 641028",
    "S/f no 3, 4, Udayampalayam Rd, near hindusthan matriculation school, Sowri Palayam, Tamil Nadu 641028",
    "6, Udayampalayam Rd, near, Coimbatore, Tamil Nadu 641028",
    "1228, Avinashi Rd, Peelamedu, Maheshwari Nagar, Masakalipalayam, Coimbatore, Tamil Nadu 641037",
  "490, Avinashi Rd, Pappanaickenpalayam, Coimbatore, Tamil Nadu 641004",
  "Survey No, 1258/1260, 333, Avinashi Rd, nr. Sri Ramakrishna Dental Clg & Hospital, Peelamedu, Coimbatore, Tamil Nadu 641004"
]
nodes = ["K100",
        "K101",
        "K102",
        ...
        "C12"]
k = nodes.copy()
API_KEY = "YOUR BING API KEY"  # Replace with your Bing Maps API key
...
orders = [[1, "C10", "K100", 705], [10, "C10", "K100", 710],
  ...
  [8, "C11", "K100", 605], [11, "C10", "K100", 735],
